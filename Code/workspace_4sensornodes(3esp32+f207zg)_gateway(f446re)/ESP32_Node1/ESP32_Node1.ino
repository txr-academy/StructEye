...
void setup() {
  ...
  // Configure MPU6050 INT pin (GPIO4) as input for motion interrupt
  pinMode(MPU_INT, INPUT);

  // Configure Onboard LED for TX visual feedback
  ...
  if (!LoRa.begin(433E6)) {
    ...
    // Set to SF9 for extreme robustness against room noise!
    LoRa.setSpreadingFactor(7);
    LoRa.setSignalBandwidth(125E3);
    LoRa.setCodingRate4(5);
    LoRa.setSyncWord(0x12);
    LoRa.enableCrc();  // CRITICAL: Required for STM32 to accept the packet!
  }
